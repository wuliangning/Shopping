		...
		<div class="ui_content">
			<table  cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
				<tr>
					...
					<td >
						<input type="text" id="fyPsdz" name="id" value="${member.id}" class="ui_input_txt02"/>
					</td>
				
					<td >登录名称</td>
					<td class="ui_text_lt">
						<input type="text" id="fyPsdz" name="wareName" value="${member.loginName}" class="ui_input_txt02"/>
					</td>
				</tr>
				<tr>
					<td class="ui_text_rt">登录密码</td>
					<td >
						<input type="text" id="fyPsdz" name="wareDate" value="${member.pwd}" class="ui_input_txt02"/>
					</td>
				
					<td >昵称</td>
					<td class="ui_text_lt">
						<input type="text" id="fyPsdz" name="wareWhere" value="${member.nickName}" class="ui_input_txt02"/>
					</td>
				</tr>
				<tr>
					<td class="ui_text_rt">年龄</td>
					<td >
						<input type="text" id="fyPsdz" name="wareMoney" value="${member.age}" class="ui_input_txt02"/>
					</td>

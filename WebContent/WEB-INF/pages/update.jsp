...
<script type="text/javascript" src="../statics/scripts/jquery/jquery-1.4.4.min.js"></script>
<script src="../statics/scripts/My97DatePicker/WdatePicker.js" type="text/javascript" defer="defer"></script>
<script type="text/javascript" src="../statics/scripts/artDialog/artDialog.js?skin=default"></script>
...
<body>
<form id="submitForm" name="submitForm" action="/Shopping/wares/update" method="post">
		...
		<div class="ui_content">
			<table  cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
				<tr>
					...
					<td >
						<input type="text" id="fyPsdz" name="id" value="${wares.id}" class="ui_input_txt02"/>
					</td>
				
					<td >商品名称</td>
					<td class="ui_text_lt">
						<input type="text" id="fyPsdz" name="wareName" value="${wares.wareName}" class="ui_input_txt02"/>
					</td>
				</tr>
				<tr>
					<td class="ui_text_rt">商品出厂日期</td>
					<td >
						<input type="text" id="fyPsdz" name="wareDate" value="${wares.wareDate}" class="ui_input_txt02"/>
					</td>
				
					<td >商城出场地</td>
					<td class="ui_text_lt">
						<input type="text" id="fyPsdz" name="wareWhere" value="${wares.wareWhere}" class="ui_input_txt02"/>
					</td>
				</tr>
				<tr>
					<td class="ui_text_rt">商品价格</td>
					<td >
						<input type="text" id="fyPsdz" name="wareMoney" value="${wares.wareMoney}" class="ui_input_txt02"/>
					</td>
